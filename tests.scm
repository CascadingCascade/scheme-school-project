...
; can't be bothered with actually doing arbitrary precision arithmetics
...
; unfortunately due to Java itself not having tail call optimization, this will overflow the JVM call stack
; you can inspect the code and manually verify that tail call optimization is implemented
; we can probably circumvent that with some elbow grease, but I can't be bothered with rewriting the evaluator into a loop
